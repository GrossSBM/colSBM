...
#> 
#> 
#> ==== Best fits criterion for the 2 networks. Computed in 0.475 secs ====
#> Sep BiSBM total BICL:  -640.6602
#> colBiSBM BICL: -633.8671
#> Joint modelisation preferred. With Q = ( 2, 2 ).
#> 
#> ==== Full computation performed in 10.9 secs ====
```
...
#> 
#> ==== Full computation performed in 21 secs ====
```
...
#> ℹ A save file will be created at "/tmp/RtmpoIaGca/file64d21e4d9046.Rds" and updated after each step
#> 
...
#> ℹ The final results are saved at "/tmp/RtmpoIaGca/file64d21e4d9046.Rds"
```
