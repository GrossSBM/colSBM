...
#> [2,] -720 -614 -604 -603 -Inf
#> [3,] -720 -606 -592 -586 -Inf
...
#> ICL    : 
#>       [,1] [,2] [,3] [,4] [,5]
#> [1,] -729 -635 -643 -652 -Inf
#> [2,] -733 -652 -667 -690 -Inf
#> [3,] -739 -672 -659 -667 -Inf
#> [4,] -Inf -Inf -Inf -Inf -Inf
#> [5,] -Inf -Inf -Inf -Inf -Inf
#> [6,] -Inf -Inf -Inf -Inf -Inf 
#> 
...
#> [2,] -730 -634 -634 -643 -Inf
#> [3,] -736 -636 -636 -644 -Inf
#> [4,] -Inf -Inf -Inf -Inf -Inf
#> [5,] -Inf -Inf -Inf -Inf -Inf
#> [6,] -Inf -Inf -Inf -Inf -Inf 
#> 
...
#> 
#> 
#> ==== Best fits criterion for the 2 networks. Computed in 0.404 secs ====
#> Sep BiSBM total BICL:  -640.6602
#> colBiSBM BICL: -633.793
#> Joint modelisation preferred. With Q = ( 2, 3 ).
#> 
#> ==== Full computation performed in 11.5 secs ====
```
...
#> 
#> 
#> ==== Best fits criterion for the 4 networks. Computed in 1.06 secs ====
#> Sep BiSBM total BICL:  -813.0666
#> colBiSBM BICL: -817.5148
#> Separated modelisation preferred.
#> 
#> ==== Full computation performed in 8.95 secs ====
```
...
#> ℹ A save file will be created at "/tmp/RtmpSYHXXZ/file64ca6a21fa70.Rds" and updated after each step
#> 
...
#> ℹ The final results are saved at "/tmp/RtmpSYHXXZ/file64ca6a21fa70.Rds"
```
