...
#> 
#> 
#> ==== Best fits criterion for the 2 networks. Computed in 0.488 secs ====
...
#> 
#> 
#> ==== Best fits criterion for the 4 networks. Computed in 1.28 secs ====
...
#> ℹ A save file will be created at "/tmp/RtmpdwX6Au/file64a61d3c23e1.Rds" and updated after each step
#> 
...
#> ℹ The final results are saved at "/tmp/RtmpdwX6Au/file64a61d3c23e1.Rds"
```
