...
#> 
#> 
#> ==== Best fits criterion for the 2 networks. Computed in 0.373 secs ====
#> Sep BiSBM total BICL:  -640.6602
#> colBiSBM BICL: -633.8671
#> Joint modelisation preferred. With Q = ( 2, 2 ).
#> 
#> ==== Full computation performed in 10.3 secs ====
```
...
#> 
#> 
#> ==== Best fits criterion for the 4 networks. Computed in 1.1 secs ====
#> Sep BiSBM total BICL:  -813.0666
#> colBiSBM BICL: -816.8325
#> Separated modelisation preferred.
#> 
#> ==== Full computation performed in 21.4 secs ====
```
...
#> ℹ A save file will be created at "/tmp/RtmpphQGWW/file75095573cd58.Rds" and updated after each step
#> 
...
#> ℹ The final results are saved at "/tmp/RtmpphQGWW/file75095573cd58.Rds"
```
